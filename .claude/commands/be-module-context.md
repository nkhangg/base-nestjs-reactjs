Load context for a specific BE domain module (be-base) before doing any work on it.

## Arguments

`$ARGUMENTS` — format: `<module-name>`

The module name should match a file in `be-base/.claude/modules/`. Examples: `user`, `blog`, `merchant`, `notification`, `audit`, `media`, `config`, `admin`.
...
- `be-base/.claude/modules/<module-name>.md`

If the file does not exist, stop and tell the user: "No module doc found for '<module-name>'. Available modules: $(list files in be-base/.claude/modules/ without extension)."

---

### STEP 2 — Detect and read core dependencies

Based on what you find in the module doc (imports, dependencies, events, queue references), read the relevant core docs from `be-base/.claude/modules/`:
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 [BE] MODULE CONTEXT LOADED: <module-name>
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Module doc:   be-base/.claude/modules/<module-name>.md
