...
export class AppConfig extends BaseEntity<ConfigId> {
  ...
  static create(params: {
    ...
    return new AppConfig(ConfigId.create(), {
      ...
      value: params.value,
      valueKeyOrder: params.valueKeyOrder ?? [],
  ...
  update(params: {
    ...
    if (params.valueKeyOrder !== undefined)
      this.props.valueKeyOrder = params.valueKeyOrder;
  ...
  get valueKeyOrder(): string[] {
    return this.props.valueKeyOrder;
  }
